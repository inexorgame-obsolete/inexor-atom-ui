 ...
 * GTK+ at <a href="ftp://ftp.gtk.org/pub/gtk/" title="ftp://ftp.gtk.org/pub/gtk/">ftp://ftp.gtk.org/pub/gtk/</a>.
 */
...
static void ghb_compositor_class_init(GhbCompositorClass *class)
{
